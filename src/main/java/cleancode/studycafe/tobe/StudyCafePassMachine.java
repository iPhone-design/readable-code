...
public class StudyCafePassMachine {
    ...
    public void run() {
        try {
            ...
            StudyCafeSeatPass selectedPass = selectedPass();
    ...
    private List<StudyCafeSeatPass> findPassCandidateBy(StudyCafePassType studyCafePassType) {
        StudyCafeSeatPasses allStudyCafeSeatPasses = seatPassProvider.getSeatPasses();
        return allStudyCafeSeatPasses.findPassBy(studyCafePassType);
    }
